...
native class SampleableTexture2DArray<ST> {
 ~SampleableTexture2DArray();
  ...
  deviceonly Load(coord : uint<2>, level : uint, layer : uint) : ST<4>;
  deviceonly GetSize() : uint<2>;
}
...
native class Math {
 ~Math();
  ...
  static dot(v : float<3>)  : float;
  static dot(v : float<4>)  : float;
...
class R16float : PixelFormat<float, ushort> {}       // FIXME: should be half

class RG16uint : PixelFormat<uint, ushort<2>> {}
class RG16sint : PixelFormat<int, short<2>> {}
class RG16float : PixelFormat<float, ushort<2>> {}   // FIXME: should be half

class RGBA16uint : PixelFormat<uint, ushort<4>> {}
class RGBA16sint : PixelFormat<int, short<4>> {}
class RGBA16float : PixelFormat<float, ushort<4>> {} // FIXME: should be half
