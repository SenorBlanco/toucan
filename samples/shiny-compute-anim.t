...
class ComputeBindings {
  var controlPoints : *storage Buffer<[]<3>float>;
...
var teapotControlPointsBuffer = new storage Buffer<[]<3>float>(device, teapotControlPoints.length);
...
var duration = 2.0;
var animTeapotControlPoints = [teapotControlPoints.length] new <3>float;
