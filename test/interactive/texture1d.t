...
var verts : [4] Vertex;
verts[0] = { position = {-1.0, -1.0, 0.0, 1.0}, texCoord = 0.0 };
verts[1] = { position = { 1.0, -1.0, 0.0, 1.0}, texCoord = 1.0 };
verts[2] = { position = {-1.0,  1.0, 0.0, 1.0}, texCoord = 0.0 };
verts[3] = { position = { 1.0,  1.0, 0.0, 1.0}, texCoord = 1.0 };
