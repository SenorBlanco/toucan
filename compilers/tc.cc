...
const char* features = "";
  ...
  if (spirv) {
    ...
    auto targetShaderLanguage = targetTripleStr == "wasm32-unknown-unknown" ? TargetShaderLanguage::WGSL : TargetShaderLanguage::SPIRV;
    CodeGenLLVM codeGenLLVM(&context, &types, module.get(), &builder, &fpm, targetShaderLanguage);
