...
std::string targetTripleStr;
  ...
  if (spirv) {
    ...
    auto targetShadingLanguage = targetTripleStr == "wasm32-unknown-unknown" ? TargetShadingLanguage::WGSL : TargetShadingLanguage::SPIRV;
    CodeGenLLVM codeGenLLVM(&context, &types, module.get(), &builder, &fpm, targetShadingLanguage);
