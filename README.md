...
```
   cmake -B out/Release-ios -D CMAKE_BUILD_TYPE=Release -D MOBILE_PROVISION_FILE=$MOBILE_PROVISION_FILE -D CODESIGN_IDENTITY=$CODESIGN_IDENTITY -D TEAM_IDENTIFIER=$TEAM_IDENTIFIER -D CMAKE_SYSTEM_NAME=iOS -D CMAKE_OSX_ARCHITECTURES=arm64 -D CMAKE_SYSTEM_PROCESSOR=arm64 -G Ninja
   cmake --build out/Release
```
